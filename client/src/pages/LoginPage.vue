           ...
           <q-card-section>
             ...
             <q-form ref="loginForm" class="q-gutter-md q-mt-lg">
               ...
               <q-input
                 ...
                 :rules="[rules.required]"
               />
               <q-checkbox :label="$t('login.keepMeLoggedIn')" model-value="" />
             </q-form>
           </q-card-section>
...
const loginForm = ref();
const loginImage = 'https://images.unsplash.com/photo-1591154669695-5f2a8d20c089?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80'
